...
//    }
    ...
    public LocalPageLoader(PageView pageView, String title, String content) {
        super(pageView, title, content);
        mStatus = STATUS_PARING;
    }
...
//        mBookFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/okok.txt");
//        try {
...
//            byte[]
//                    content = Files.readAllBytes(new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/okok.txt").toPath());
//            return content;
...
//        mBookFile = new File(mCollBook.getCover());
        //获取文件编码
//        mCharset = FileUtilss.getCharset(mBookFile.getAbsolutePath());
...
//                        BookRepository.getInstance().saveCollBook(mCollBook);
                        ...
                        // 加载并显示当前章节
                        if (LocalPageLoader.super.titlePage != null && LocalPageLoader.super.contentPage != null)
                            openChapter();
                    }
...
//        BufferedReader br = new BufferedReader(new InputStreamReader(bais, mCharset.getName()));
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/okok.txt");
