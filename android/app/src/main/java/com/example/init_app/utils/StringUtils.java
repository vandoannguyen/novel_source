...
import com.example.init_app.MainApplicaiton;
import com.example.init_app.pageview_utils.ConversionType;
...
import static com.example.init_app.pageview_utils.page.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id){
        return MainApplicaiton.getContext().getResources().getString(id);
    }

    public static String getString(@StringRes int id, Object... formatArgs){
        return MainApplicaiton.getContext().getResources().getString(id,formatArgs);
    }
    ...
    public static String convertCC(String input, Context context)
    {
        ...
        int convertType = SharedPrefsUtils.getInstance(context).getInt(SHARED_READ_CONVERT_TYPE, 0);
