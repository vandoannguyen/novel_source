...
public class ReadSettingManager {
    ...
    private SharedPrefsUtils sharedPreUtils;
    ...
    private ReadSettingManager(Context context) {
        sharedPreUtils = SharedPrefsUtils.getInstance(context);
    }
    ...
    public boolean isDefaultTextSize() {
        return sharedPreUtils.getBoolean(SHARED_READ_IS_TEXT_DEFAULT);
    }
    ...
    public boolean isNightMode() {
        return sharedPreUtils.getBoolean(SHARED_READ_NIGHT_MODE);
    }
    ...
    public boolean isVolumeTurnPage() {
        return sharedPreUtils.getBoolean(SHARED_READ_VOLUME_TURN_PAGE);
    }
    ...
    public boolean isFullScreen() {
        return sharedPreUtils.getBoolean(SHARED_READ_FULL_SCREEN);
    }
    ...
    public int getConvertType() {
        return sharedPreUtils.getInt(SHARED_READ_CONVERT_TYPE);
    }
}
